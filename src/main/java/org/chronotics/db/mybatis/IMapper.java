...
public interface IMapper {
    ...
    /**
     * insertWithAutoGeneratedKeys
     * If your database support AutoGeneratedKeys, then you can use this function.
     * this is mapped to the query function "insert" in a mapper file.
     * @usage
     * You can get the auto-generated key by using map.get() with the key of "autoGeneratedKey"
     * example)
     * Object autogeneratedKey = statementMap.get("autoGeneratedKey");
     * The data type of returned value is the same with that of column for "autoGeneatedKey"
     * @param _statementMap
     * _statementMap is used to complete the statement.
     * Some are to define String of a statement and
     * the others are for parameters in a prepared statement
     ...
     * the number of inserted elements
     */
    int insertWithAutoGeneratedKeys(Map<Object,Object> _statementMap);
